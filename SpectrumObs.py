...
class CoyoteObsBuilder(ObsBuilder):
    def __init__(self,
        ...
        self.had_jump = None
        self.reset_timer = 0
        self.flip_reset_count_dict=flip_reset_count_dict
        ...
        self.boosttimes = None
        self.jumptimes = None
        self.fliptimes = None
        self.has_flippeds = None
        self.has_doublejumpeds = None
        self.flipdirs = None
        self.airtimes = None
        self.on_grounds = None
        self.prev_prev_actions = None
        self.is_jumpings = None
        self.has_jumpeds = None
        self.handbrakes = None
        self.had_jump = None
    ...
    def reset(self, initial_state: GameState):
        ...
        self.inverted_boost_timers = np.zeros(
            self.boost_locations.shape[0])
        self.demo_timers = np.zeros(len(initial_state.cars))
        self.blue_obs = []
        self.orange_obs = []
